...
import { Container, Content, AvatarInput, Menu } from './styles';
...
const Profile: React.FC = () => {
  ...
  const handleDeleteAvatar = useCallback(() => {
    api.delete('/users/avatar/delete').then((response) => {
      updateUser(response.data);
    });
  }, [updateUser]);
      ...
      <Content>
        ...
        >
          <AvatarInput>
            ...
            <label onClick={() => setVisibleMenu(!visibleMenu)}>
              <FiCamera />
            </label>

            <Menu isVisible={visibleMenu}>
              <label onClick={handleDeleteAvatar}>Remover avatar</label>
